...
3. И последняя группа, это фракции-лидеры, фракции-лидеры состоят из 200 счетов и избираются 200 счетов, которые получили наибольшее количество 
   голосов (VOTE_STOCK). Но их
...
Для всех участников учитываются только голоса, от которых не прошло больше одного года. Голоса динамически меняются с каждым блоком 
...
сжигаются 0.2% цифровых долларов и 0.4% цифровых акций.
