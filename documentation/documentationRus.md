...
3. Совет Директоров - это аналог палаты представителей.
   ...
   суммируем отдельно ДА и НЕТ и вычитаем от ДА - НЕТ (участвует только внесении поправок)
...
и 10% или больше от фракций. Но закон должен быть одобрен всеми 3 группами.
