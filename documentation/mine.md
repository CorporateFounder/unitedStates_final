# Добыча блока
чтобы начать манить нужно после запуска, зайти на 
на http://localhost:8082/ внизу будет кнопка майнинг mining block,
после нажатия на него активируется процесс майнинга.
Сложность блокчейна адаптируется аналогично биткоину, но адаптация происходит 
раз в пол дня.
