...
Вы можете сделать так, например вы видите максимальное число
9223372036854775807 и говорите первому ПК искать с нуля, а второму задаете настройки
уже с середины. Таким образом каждый ваш ПК будет искать со своего места.
После рестарта jar все сбрасывается до 0. 
