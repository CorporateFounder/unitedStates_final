...
если вы хотите проголосовать за какой то закон, возмите его адресс который 
есть в http://localhost:8082/all-laws
пример адресса LIBER489cd5a211fc67177e79a10a882120e3b3cb1cc90a053d40cd1ce4bda5f31f9a

ввойдите в 
http://localhost:8082/
впишите адресс отпавителя, а в качетсве адреса получателя введите полученый адресс закона,
дайте любую сумму вознаграждение майнеру, и Выберите YES или NO, 
отправлять в данном случае цифровые доллары и цифровые акции не нужно, поставте их на ноль.
Ведите ваш ***пароль***
