...
public class Testing {
    ...
    @Test
    public void testAccounts () throws JSONException, IOException {
        String host = "http://194.87.236.238:82";
        String json = UtilUrl.readJsonFromUrl(host+"/account?address=h392yDGLyzh4Bk3A8hfGvi8qiGK84X4TWWTSTe55jMM4");
